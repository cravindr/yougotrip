...
<!-- Option Selection start -->
      ...
      <div class="row-form">
          ...
          <input type="text" name="title"  id="title" value="{$input_title}" placeholder="eg. company images" class="validate[required]"/></div>
      </div>
      ...
      <div class="row-form">
          ...
          <div class="span8 input-prepend">          
          	<div class="data-fluid editor">
                <textarea id="description"  name="description" style="height: 300px;">{$input_desc}</textarea>
            </div>
          </div>
      </div>
