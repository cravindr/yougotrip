<?php /* Smarty version Smarty-3.1.14, created on 2013-09-28 17:17:03
...
>
                        <a href="#" class="blgreen">Booking</a>
                        <div class="open"></div>
                        <ul>
                            <li><a href="customer_register.php">Customer Registration</a></li>
...
>
                        <a href="#" class="blred">Accounts Reports</a>
                        <div class="open"></div>
                        <ul>
                            <li><a href="report_transactions.php">Customer Transactions</a></li>
                            <li><a href="report_booking.php">Booking</a></li>
                        </ul>
                    </li>                
