    ...
    <script type='text/javascript' src='assets/js/jquery/jquery-ui-1.10.1.custom.min.js'></script>
    <script type='text/javascript' src='assets/js/shbrush/XRegExp.js'></script>
    <script type='text/javascript' src='assets/js/shbrush/shCore.js'></script>    
