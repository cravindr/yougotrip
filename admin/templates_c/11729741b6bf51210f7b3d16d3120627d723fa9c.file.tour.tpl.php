<?php /* Smarty version Smarty-3.1.14, created on 2015-12-11 13:10:54
         compiled from "templates\tour.tpl" */ ?>
<?php /*%%SmartyHeaderCode:476752beb9a237c537-15750494%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '476752beb9a237c537-15750494',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52beb9a29c9ad8_08290200',
  'variables' => 
  array (
    'tourpack_post_url' => 0,
    'input_packagetype' => 0,
...
<?php if ($_valid && !is_callable('content_52beb9a29c9ad8_08290200')) {function content_52beb9a29c9ad8_08290200($_smarty_tpl) {?>            
...
<!-- Option Selection start -->
     ...
     <div class="row-form">
          ...
          <input type="text" name="packagetype" id="packagetype" placeholder="Package" autocomplete="off" auto-complete="false" value="<?php echo $_smarty_tpl->tpl_vars['input_packagetype']->value;?>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="placedesc">
                         <div class="span10">
                            ...
                            <div class="data-fluid editor">
                                <textarea id="place_desc"  name="place_desc" style="height: 300px;"><?php echo $_smarty_tpl->tpl_vars['input_place_desc']->value;?>
</textarea>
                            </div>
                        </div>
                    </div>
...
>
      ...
      <div class="row-form">
        ...
        <div class="row-form">
          ...
          <div class="span4 input-prepend">
          <span class="add-on blue"><i class="icon-map-marker icon-white"></i></span>
          <input type="text" name="title_desc"  id="title_desc" placeholder="eg. Singapore Malaysia tour" value="<?php echo $_smarty_tpl->tpl_vars['input_title_desc']->value;?>
"   /></div>
      </div>
...
"  placeholder="eg. gallery, images, etc..." /></div>
      ...
      <div class="row-form">
          ...
          <div class="span4 input-prepend">
          <span class="add-on blue"><i class="icon-map-marker icon-white"></i></span>
          <input type="text" name="staticurl"  id="staticurl" value="<?php echo $_smarty_tpl->tpl_vars['input_staticurl']->value;?>
"  placeholder="eg. international-asia-singapore-3days" class="validate[required,maxSize[250]]"  />
          <!--<input type="text" name="staticurl"  id="staticurl" value="<?php echo $_smarty_tpl->tpl_vars['input_staticurl']->value;?>
"  placeholder="eg. international-asia-singapore-3days" class="validate[required,maxSize[250],ajax[ajaxURLCallPhp]]"  />-->
          </div>
      </div>
