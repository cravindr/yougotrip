    ...
    <input type="hidden" name="crmid" value="{$crmid}"  />
         <div class="row-form">
          ...
          <div class="row-form">
            ...
            <div class="span2 ">
            <input type="text" name="idate" id="idate" placeholder="eg.2013/12/30" value="{$issue_date}" class="datepicker validate[custom[date]]"/>
            </div>
            <div class="span1">Exp Date</div>
            <div class="span2 ">
              
              <input type="text" name="edate" id="edate" placeholder="eg.2013/12/30" value="{$exp_date}" class="datepicker validate[custom[date]]"/>
            </div>
          </div>
          ...
          <div class="row-form">
                ...
                <div class="span4 input-prepend">
                  <span class="add-on blue"><i class="icon-signal icon-white"></i></span>
                  <input type="text" name="ncdate" id="ncdate" placeholder="eg.01/12/2013" value="{$ncdate}" class=" datepicker validate[maxSize[11],custom[date]]"/>
                </div>
          ...
          <div class="span2">Lead Source</div>
                ...
                <div class="span4 input-prepend">
                  <span class="add-on blue"><i class="icon-signal icon-white"></i></span>
                  <input type="text" name="pack" id="pack" placeholder="Interested Package" value="{$package}" class="validate[maxSize[200]]"/>
                </div>
