...
<form id="validate" method="POST" action="{$category_post_url}">
...
<!-- Option Selection start -->
     ...
     <div class="row-form">
          ...
          <input type="text" name="cname" id="cname" placeholder="Category Name" value="{$category_name}" class="validate[required,maxSize[100]]"/></div>
