...
<!--              <input type="text" name="address" id="address" placeholder="Address" value="{$input_address}" class="validate[required]"/>-->
              <textarea name="address" id="address" placeholder="Address" class="validate[required]">{$input_address}</textarea>
              </div>
          </div>
        ...
        <!--  <div class="row-form">
          ...
          <div class="row-form">
              ...
              <div class="span9 input-prepend">
              <span class="add-on blue"><i class="icon-arrow-down icon-white"></i></span>
              <input type="email" name="email" id="email"  placeholder="Email"  value="{$input_email}"  {$emailvalidate}/>
              </div>
          </div>
...
<div class="span6">
      ...
      <div class="row-form">
          ...
          <div class="span9 input-prepend">
          <span class="add-on blue"><i class="icon-arrow-down icon-white"></i></span>
          <input type="text" name="cmp_reg_no" id="cmp_reg_no" placeholder="Company Register Number" value="{$input_cmp_reg_no}"  />
          </div>
      </div>
      ...
      <div class="row-form">
          ...
          <div class="span9 input-prepend">
          <span class="add-on blue"><i class="icon-arrow-down icon-white"></i></span>
          <input type="text" name="cmp_vat_no" id="cmp_vat_no" placeholder="Compatny VAT Number" value="{$input_cmp_vat}" />
          </div>
      </div>
      ...
      <div class="row-form">
          ...
          <div class="span9 input-prepend">
          <span class="add-on blue"><i class="icon-arrow-down icon-white"></i></span>
          <input type="text" name="cmp_service_tax" id="cmp_service_tax" placeholder="Service Tax Number" value="{$input_cmp_service_tax}" />
          </div>
      </div>
      ...
      <div class="row-form">
          ...
          <textarea name="cmp_address" id="cmp_address" placeholder="Company Address" class="validate[required]">{$input_cmp_address}</textarea>
          </div>
      </div>
      ...
      <div class="row-form">
          ...
          <div class="span9 input-prepend">
          <span class="add-on blue"><i class="icon-arrow-down icon-white"></i></span>
          <input type="text" name="cmp_bank_details" id="cmp_bank_details" placeholder="Company Bank Details" value="{$input_cmp_bank_details}" />
          </div>
      </div>
