<script src="jscript/customerlist.js" type="text/javascript"></script>
	<div class="block">
                ...
                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="20%">{$tbl_th_name}</th>
                            <th width="20%">{$tbl_th_company}</th>
                            <th width="20%">{$tbl_th_meta_city}</th>
                            <!-- <th width="20%">{$tbl_th_status}</th>  -->
                            <th width="20%">{$tbl_th_meta_mobile}</th>  
